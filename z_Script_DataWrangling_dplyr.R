...
dataset_inicial <- read_excel("raw_datas_exemplos/(1.2) Dataset Aula Data Wrangling.xls")
dataset_merge <- read_excel("raw_datas_exemplos/(1.3) Dataset Aula Data Wrangling (Join).xls")
